...
| D-013 Codrops Rotating On-Scroll Animations Variation 3 | https://github.com/codrops/RotatingOnScrollAnimations @ `ebbe2c9` | WO-031 | Adapted into `case-study-evidence-plane.tsx` / `case-study-evidence-stage.tsx` |
