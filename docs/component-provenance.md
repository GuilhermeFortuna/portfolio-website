...
| --- | --- | --- | --- | --- | --- |
| Identity Scroll Choreography | https://21st.dev/@componentry/components/scroll-choreography | `src/components/resume/resume-identity-scene.tsx` | Existing Motion runtime only; no source package | Clean-room adaptation authorized by owner on 2026-09-08: replaced four image quadrants with five factual typographic/data plates, retained staged convergence, preserved the semantic hero and early PDF/contact actions, and added deterministic CSS geometry/fallbacks. No upstream source, media, or demo copy was copied. | Public code/usage inspected 2026-09-08; author componentry; published 2026-07-10; license and immutable revision not exposed; owner waived the license gate for this clean-room concept adaptation. |
| Capability Radial Orbital Timeline | https://21st.dev/@jatin-yadav05/components/radial-orbital-timeline | `src/components/resume/resume-capability-orbit.tsx` | Existing Motion runtime only; no `lucide-react` dependency | Mapped exactly six existing skill groups; removed status, energy, date, relation, icon, and generated-description claims; retained one semantic nested list, native-button selection, and wrapping fallback. | Public code/usage inspected 2026-09-08; author Jatin Yadav; MIT License declared; immutable revision not exposed. |
