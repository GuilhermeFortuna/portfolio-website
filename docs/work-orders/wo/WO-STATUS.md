...
| [WO-009](WO-009-selected-work-sparkles.md) | `READY` | WO-008 | Unassigned | — | WO-008 is complete; Selected Work heading contains exactly one Sparkles slot. |
| [WO-010](WO-010-shape-blur-interaction.md) | `READY` | WO-008 | Unassigned | — | WO-008 is complete; desktop project stage contains exactly one Shape Blur slot. |
