...
function ExternalLink({ href, children }: { href: string; children: ReactNode }) {
  return (
    <a href={href} target="_blank" rel="noreferrer" className="resume-identity__external-link">
      {children}
    </a>
  );
}
...
export function ResumeIdentityScene({
  ...
  const plates = [identity.focus, identity.role, location, availability, labels.skills];
      ...
      <header className="resume-identity__content">
        ...
        <div className="resume-identity__actions">
          ...
          <div className="resume-identity__buttons">
            ...
            <a href={pdf.href} download={pdf.downloadName} className="resume-identity__button">
              {labels.downloadPdf}
            </a>
            {contactLink ? (
